...
class IncompatibleUnitsError(ValueError):
    ...
    def __init__(
        ...
        Args:     from_unit: The source unit that cannot be converted     to_unit: The
        target unit that cannot be converted to
        """
    ...
    def get_from_unit(self) -> IngredientUnitEnum:
        ...
        Returns:     IngredientUnitEnum: The unit that conversion was attempted from.
        """
    ...
    def get_to_unit(self) -> IngredientUnitEnum:
        ...
        Returns:     IngredientUnitEnum: The unit that conversion was attempted to.
        """
        return self.to_unit
...
class RecipeScrapingError(Exception):
    ...
    This exception is raised when: - The URL is invalid or malformed - The recipe
    blog/website is not compatible with the scraper - The website structure prevents
    successful scraping - Network or access issues prevent scraping
    """

    def __init__(self, url: str, reason: str | None = None) -> None:
        """Initialize the exception with the URL and optional reason.

        Args:     url: The URL that could not be scraped.     reason: Optional specific
        reason for the scraping failure.
        """
        self.url = url
        self.reason = reason
    ...
    def get_url(self) -> str:
        ...
        Returns:     str: The URL that could not be scraped.
        """
        return self.url
    ...
    def get_reason(self) -> str | None:
        ...
        Returns:     str | None: The reason for failure, if provided.
        """
        return self.reason
...
class SubstitutionNotFoundError(Exception):
    ...
    This exception is raised when: - The external substitution service has no data for
    the ingredient - The ingredient is too specific or rare to have common substitutes -
    ...
    def __init__(self, ingredient_name: str, reason: str | None = None) -> None:
        ...
        Args:     ingredient_name: The name of the ingredient that has no substitutes.
    ...
    def get_ingredient_name(self) -> str:
        ...
        Returns:     str: The ingredient name that has no substitutes.
        """
