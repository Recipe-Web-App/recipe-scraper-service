...
class PairingSuggestionsResponse(BaseSchema):
    ...
    Attributes:     recipe_id (int): The ID of the recipe being evaluated for pairing.
    pairing_suggestions (list[WebRecipe]): A list of recommended pairing recipes. limit
    (int): The maximum number of items returned.     offset (int): The offset used for
    pagination.     count (int): The total number of available suggestions.
    """
    ...
    def from_all(
        ...
        Args:     recipe_id (int): The ID of the recipe for which suggestions are being
        made.     pairing_suggestions (list[WebRecipe]): The full list of suggested
        recipes.     pagination (PaginationParams): Pagination params for response
        control.

        Returns:     PairingSuggestionsResponse: The paginated pairing suggestions
        response.
        """
